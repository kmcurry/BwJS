...
HTMLLabel.prototype.updateShowStates = function()
{
    switch (this.show.getValueDirect())
    {
        case true:
            {
                if (this.vScrollBar)
                    this.vScrollBar.getAttribute("show").setValueDirect(this.showStates.vScrollBar);
                if (this.hScrollBar)
                    this.hScrollBar.getAttribute("show").setValueDirect(this.showStates.hScrollBar);
            }
            break;
        ...
        case false:
            {
                if (this.vScrollBar)
                    this.vScrollBar.getAttribute("show").setValueDirect(false);
                if (this.hScrollBar)
                    this.hScrollBar.getAttribute("show").setValueDirect(false);
...
HTMLLabel.prototype.getRenderingPositions = function(labelX, labelY)
{
    ...
    if (this.rasterPosition.modificationCount > 0)
    {
